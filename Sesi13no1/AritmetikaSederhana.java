 ...
 * @author jembar
 */
public class AritmetikaSederhana  extends JFrame implements ActionListener {
  ...
  public AritmetikaSederhana() {
    // Menetapkan titel frame
    super("Proses Aritmetika Sederhana");
  ...
  public static void main(String[] args) {
    AritmetikaSederhana frame = new AritmetikaSederhana();
